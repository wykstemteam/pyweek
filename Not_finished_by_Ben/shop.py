...
def shop_confirm_menu(button, window: pygame.Surface):
    ...
    confirm_screen = pygame_gui.UIManager((SCREEN_WIDTH, SCREEN_HIGHT))
...
def shop_main_menu(window: pygame.Surface):
    ...
    shop_screen = pygame_gui.UIManager((SCREEN_WIDTH, SCREEN_HIGHT))
