...
class Shop:
    def __init__(self, confirm_button: pygame.Surface, main_menu: pygame.Surface, darken: pygame.Surface):
        self.confirm_button = confirm_button
        self.main_menu = main_menu
        self.darken = darken
        self.shop_screen = pygame_gui.UIManager((SCREEN_WIDTH, SCREEN_HEIGHT), 'shop_display_theme.json')
        ...
        self.buttons = [pygame_gui.elements.UIButton(relative_rect=self.button_positions[i],
                                                     text='',
                                                     object_id=f'#button_{i+1}',
                                                     manager=self.shop_screen) for i in range(6)]

    def appear(self, window: pygame.Surface):
    ...
    def confirm_menu(self, button_name: str, window: pygame.Surface):
        confirm_screen = pygame_gui.UIManager((SCREEN_WIDTH, SCREEN_HEIGHT), 'shop_confirm_theme.json')
